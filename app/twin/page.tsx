    ...
    <main className="container page-section twin-page">
      ...
      <section className="twin-architecture" aria-labelledby="architecture-title">
        ...
        <div className="twin-grid">
          {[
            ["01", "Orchestrator", "Routes the visitor question through retrieval, memory, policy, and response generation."],
            ["02", "RAG Engine", "Uses vector similarity search over verified resume, project, profile, and note chunks."],
            ["03", "Memory Layer", "Keeps conversation continuity and supports salience-ranked long-term memories."],
            ["04", "Evidence Layer", "Returns human-readable source citations so recruiters can inspect what grounded the answer."],
